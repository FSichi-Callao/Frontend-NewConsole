...
export const SelectInput = ({ value, setValue, inputTitle, inputName, dataOptions, col }) => {
    return (
        <div className={`col-md-${col ? col : '6'} col-sm-12 col-lg-${col ? col : '3'}`}>
            <label for="user" className="col-form-label">{inputTitle}</label>
            <select
